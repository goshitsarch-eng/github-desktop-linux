...
def test_window_actions_cover_menus() -> None:
    ...
    for phrase in [
        ...
        "@username",
        "Co-Authors",
        "getDisplayTextForAuthor",
        "getFullTextForAuthor",
        "isKnownAuthor",
        ...
        "Pull, push, or fetch",
        "actionInProgress",
        "setScreenReaderLoadingStateMessage",
