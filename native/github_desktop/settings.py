...
sidebarWidthConfigKey = "sidebar-width"
commitSummaryWidthConfigKey = "commit-summary-width"
defaultSidebarWidth = 250
defaultCommitSummaryWidth = 250
...
class Settings:
    ...
    sidebar_width: int = defaultSidebarWidth
    commit_summary_width: int = defaultCommitSummaryWidth
