...
The source for the Windows shell integration is found in [`app/src/lib/shells/win32.ts`](https://github.com/goshitsarch-eng/github-desktop-linux/blob/main/app/src/lib/shells/win32.ts).
...
The source for the macOS shell integration is found in [`app/src/lib/shells/darwin.ts`](https://github.com/goshitsarch-eng/github-desktop-linux/blob/main/app/src/lib/shells/darwin.ts).
...
The source for the Linux shell integration is found in [`app/src/lib/shells/linux.ts`](https://github.com/goshitsarch-eng/github-desktop-linux/blob/main/app/src/lib/shells/linux.ts).
