...
Note, however that this list is likely to grow stale so I'd recommend checking [the code](https://github.com/goshitsarch-eng/github-desktop-linux/blob/main/app/src/highlighter/index.ts) directly.
